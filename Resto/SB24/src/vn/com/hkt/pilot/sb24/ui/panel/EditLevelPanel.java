...
public class EditLevelPanel extends javax.swing.JPanel implements IEnterpriseHelp, IUserInterface {

    private LevelLanguage LevelLanguage;
    private LevelLanguageBN LevelLanguageBN;
    private DefaultTableModel model;
    private List<LevelLanguage> list = new ArrayList<LevelLanguage>();
    private Collection<? extends IPersonExtCreater> ipcs;

    /** Creates new form EditChucVuPanel */
    public EditLevelPanel() {
        initComponents();
        LevelLanguageBN = new LevelLanguageBN();
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.lbDescription.text")); // NOI18N

        txtCountryName.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtCountryName.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.txtCountryName.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditLevelPanel.class, "EditLevelPanel.btnReset.text")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        LevelLanguage = list.get(tableObject.getSelectedRow());
        txtCountryName.setText(LevelLanguage.getLevelName());
    ...
    private void removeData() {
        LevelLanguageBN.delete(LevelLanguage.getId());
    ...
    private void loadData() {
        ...
        list = LevelLanguageBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (LevelLanguage bean : list) {
            String[] rows = {bean.getLevelName()};
            model.addRow(rows);
        }
    ...
    private void editData() {
        LevelLanguage.setLevelName(txtCountryName.getText());
        LevelLanguageBN.update(LevelLanguage);
        resetData();
        loadData();
    }

    private void createData() {
        LevelLanguage m = new LevelLanguage();
        m.setLevelName(txtCountryName.getText());
        LevelLanguageBN.insert(m);
        resetData();
        loadData();
    }
