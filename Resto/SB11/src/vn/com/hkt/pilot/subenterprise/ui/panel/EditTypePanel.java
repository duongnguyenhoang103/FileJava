...
public class EditTypePanel extends javax.swing.JPanel implements IEnterpriseHelp,IUserInterface {

    private EnterpriseType EnterpriseType;
    private EnterpriseTypeBN EnterpriseTypeBN;
    private DefaultTableModel model;
    private List<EnterpriseType> list = new ArrayList<EnterpriseType>();
    private Collection<? extends IEnterpriseExtCreator> ieec;

    /** Creates new form EditChucVuPanel */
    public EditTypePanel() {
        initComponents();
        EnterpriseTypeBN = new EnterpriseTypeBN();
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.lbDescription.text")); // NOI18N

        txtCountryName.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtCountryName.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.txtCountryName.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditTypePanel.class, "EditTypePanel.btnReset.text")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        EnterpriseType = list.get(tableObject.getSelectedRow());
        txtCountryName.setText(EnterpriseType.getStatusName());
    ...
    private void removeData() {
        EnterpriseTypeBN.delete(EnterpriseType.getId());
    ...
    private void loadData() {
        ...
        list = EnterpriseTypeBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (EnterpriseType bean : list) {
    ...
    private void editData() {
        EnterpriseType.setStatusName(txtCountryName.getText());
        EnterpriseTypeBN.update(EnterpriseType);
        resetData();
        loadData();
    }

    private void createData() {
        EnterpriseType m = new EnterpriseType();
        m.setStatusName(txtCountryName.getText());
        EnterpriseTypeBN.insert(m);
        resetData();
        loadData();
    }
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện chỉnh sửa loại hình kinh doanh";
    }
