...
public class EditPaymentPanel extends javax.swing.JPanel implements IEnterpriseHelp,IUserInterface {

    private PaymentMethod PaymentMethod;
    private PaymentMethodBN PaymentMethodBN;
    ...
    public EditPaymentPanel() {
        initComponents();
        PaymentMethodBN = new PaymentMethodBN();
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.lbTitle.text_1")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.jPanel1.border.title_1"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.lbDescription.text_1")); // NOI18N

        txtnameClassification.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtnameClassification.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.txtnameClassification.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.btnCreate.text_1")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.btnEdit.text_1")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.btnDelete.text_1")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditPaymentPanel.class, "EditPaymentPanel.btnReset.text_1")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        PaymentMethod = list.get(tableObject.getSelectedRow());
        txtnameClassification.setText(PaymentMethod.getPaymentMethodName());
    ...
    private void removeData() {
        PaymentMethodBN.delete(PaymentMethod.getId());
    ...
    private void loadData() {
        ...
        list = PaymentMethodBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (PaymentMethod bean : list) {
            String[] rows = {bean.getPaymentMethodName()};
            model.addRow(rows);
        }
    ...
    private void editData() {
        PaymentMethod.setPaymentMethodName(txtnameClassification.getText());
        PaymentMethodBN.update(PaymentMethod);
        resetData();
        loadData();
    }
    ...
    private void createData() {
        ...
        c.setPaymentMethodName(txtnameClassification.getText());
        PaymentMethodBN.insert(c);
        resetData();
        loadData();
    }
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện giúp đỡ hình thức thanh toán";
    }
