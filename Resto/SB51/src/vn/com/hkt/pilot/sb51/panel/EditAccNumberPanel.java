...
public class EditAccNumberPanel extends javax.swing.JPanel implements IEnterpriseHelp, IUserInterface {

    private AccountNumber accountNumber;
    private IAccountNumberBN accountNumberBN;
    private DefaultTableModel model;
    private List<AccountNumber> list = new ArrayList<AccountNumber>();
    private Collection<? extends IOperationExtCreater> ieec;

    /** Creates new form EditChucVuPanel */
    public EditAccNumberPanel() {
        initComponents();
        accountNumberBN = Lookup.getDefault().lookup(IAccountNumberBN.class);
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.lbDescription.text")); // NOI18N

        txtnameClassification.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtnameClassification.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.txtnameClassification.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditAccNumberPanel.class, "EditAccNumberPanel.btnReset.text")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        accountNumber = list.get(tableObject.getSelectedRow());
        txtnameClassification.setText(accountNumber.getAccountNumberName());
    ...
    private void removeData() {
        accountNumberBN.delete(accountNumber.getId());
    ...
    private void loadData() {
        ...
        list = accountNumberBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (AccountNumber bean : list) {
            String[] rows = {bean.getAccountNumberName()};
            model.addRow(rows);
        }
    ...
    private void editData() {
        accountNumber.setAccountNumberName(txtnameClassification.getText());
        accountNumberBN.update(accountNumber);
        resetData();
        loadData();
    }

    private void createData() {
        AccountNumber c = new AccountNumber();
        c.setAccountNumberName(txtnameClassification.getText());
        c.setAccountNumberId(String.valueOf(Math.random() * 10));
        accountNumberBN.insert(c);
        resetData();
        loadData();
    }
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện giúp đỡ chỉnh sủa số tài khoản";
    }
