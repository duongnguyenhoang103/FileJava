...
public class EditBillTypePanel extends javax.swing.JPanel implements IEnterpriseHelp,IUserInterface {

    private BillType BillType;
    private BillTypeBN BillTypeBN;
    ...
    public EditBillTypePanel() {
        initComponents();
        BillTypeBN = new BillTypeBN();
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.lbTitle.text_1")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.jPanel1.border.title_1"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.lbDescription.text_1")); // NOI18N

        txtnameClassification.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtnameClassification.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.txtnameClassification.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.btnCreate.text_1")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.btnEdit.text_1")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.btnDelete.text_1")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditBillTypePanel.class, "EditBillTypePanel.btnReset.text_1")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        BillType = list.get(tableObject.getSelectedRow());
        txtnameClassification.setText(BillType.getBillTypeName());
    ...
    private void removeData() {
        BillTypeBN.delete(BillType.getId());
    ...
    private void loadData() {
        ...
        list = BillTypeBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (BillType bean : list) {
            String[] rows = {bean.getBillTypeName()};
            model.addRow(rows);
        }
    ...
    private void editData() {
        BillType.setBillTypeName(txtnameClassification.getText());
        BillTypeBN.update(BillType);
        resetData();
        loadData();
    }

    private void createData() {
        BillType c = new BillType();
        c.setBillTypeName(txtnameClassification.getText());
        BillTypeBN.insert(c);
        resetData();
        loadData();
    }
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện giúp đỡ loại hóa đơn";
    }
