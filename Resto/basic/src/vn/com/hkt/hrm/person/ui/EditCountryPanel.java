...
public class EditCountryPanel extends javax.swing.JPanel implements IUserInterface {

    private Country country;
    private ICountryBN countryBN;
    private DefaultTableModel model;
    private List<Country> list = new ArrayList<Country>();
    private Collection<? extends ILoadComboCountry> ieec = Lookup.getDefault().lookupAll(ILoadComboCountry.class);
    private static EditCountryPanel editContryPanel;

    public static EditCountryPanel getcContryPanel() {
        if (editContryPanel == null) {
            editContryPanel = new EditCountryPanel();
        }
        return editContryPanel;
    }
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.lbDescription.text")); // NOI18N

        txtCountryName.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtCountryName.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.txtCountryName.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditCountryPanel.class, "EditCountryPanel.btnReset.text")); // NOI18N
    ...
    public void loadCombo() {
        if (ieec != null) {
            for (ILoadComboCountry extCreator : ieec) {
                extCreator.loadCombo();
            }
        }
    }

    private void removeData() {
        countryBN.delete(country.getId());
    ...
    private void loadData() {
        ...
        list = countryBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (Country bean : list) {
            String[] rows = {bean.getCountryName()};
            model.addRow(rows);
        }
    ...
    private void createData() {
        ...
        m.setCountryName(txtCountryName.getText());
        m.setCountryId(String.valueOf(Math.random() * 10));
        m.setNationality(" ");
        countryBN.insert(m);
        resetData();
        loadData();
