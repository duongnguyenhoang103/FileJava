 ...
 * @author longnt
 */
public class EditVung2Panel extends javax.swing.JPanel implements IUserInterface{
    ...
    private Partition partitionParent;

    /** Creates new form EditChucVuPanel */
    public EditVung2Panel(Country country, Partition partition) {
        initComponents();
        this.country = country;
        this.partitionParent = partition;
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.lbDescription.text")); // NOI18N

        txtCountryName.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtCountryName.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.txtCountryName.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditVung2Panel.class, "EditVung2Panel.btnReset.text")); // NOI18N
    ...
    private void loadData() {
        ...
        if (partitionParent != null) {
            list = partitionBN.getPartition2ByParent(partitionParent);
        } else {
    ...
    private void createData() {
        List<Partition> listCitys = new ArrayList<Partition>();
        listCitys = partitionBN.filterPartitionByName(txtCountryName.getText().trim());
        if (listCitys.size() > 0) {
            Partition m = listCitys.get(0);
            m.setPartitionParentIdActual(partitionParent.getId());
            partitionBN.update(m);
            resetData();
            loadData();
        } else {
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện chỉnh sửa thông tin vùng cấp 2";
    }
