 ...
 * @author longnt
 */
public class EditNationalityPanel extends javax.swing.JPanel implements IUserInterface {

    private Country country;
    private ICountryBN countryBN;
    private DefaultTableModel model;
    private Collection<? extends IPersonCreater> ieec = Lookup.getDefault().lookupAll(IPersonCreater.class);
...
//    }
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.lbDescription.text")); // NOI18N

        txtCountryName.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtCountryName.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.txtCountryName.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditNationalityPanel.class, "EditNationalityPanel.btnReset.text")); // NOI18N
    ...
    private void loadData() {
        ...
        String[] rows = {country.getNationality()};
        model.addRow(rows);
        tableObject.setModel(model);
    }

    private void loadCbo() {
        for (IPersonCreater extCreator : ieec) {
            extCreator.getLevelNumber();
        }
    }

    private void editData() {
        country.setNationality(txtCountryName.getText());
