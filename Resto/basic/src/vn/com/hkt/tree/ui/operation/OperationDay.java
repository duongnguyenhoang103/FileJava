...
public class OperationDay extends Children.Keys {
    ...
    protected Node[] createNodes(Object key) {
        ...
        Calendar c = operation1.getDateTime();
        String dateTemp = c.get(Calendar.DAY_OF_MONTH)+ "/" + c.get(Calendar.MONTH)+1 + "/" +
                c.get(Calendar.YEAR);
        result.setDisplayName(dateTemp);  // Set name cho node
...
//                        && cl.getClassificationId().equals(operation.getClassificationIdActual())) {  // có đúng parent không
...
//                            operation1.setClassificationIdActual(list.get(i).getClassificationIdActual());
