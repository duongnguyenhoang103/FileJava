 ...
 */
@ConvertAsProperties(dtd = "-//vn.com.hkt.tree.ui.department//TreeDepartmentAll//EN",
autostore = false)
@TopComponent.Description(preferredID = "TreeDepartmentAllTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "vn.com.hkt.tree.ui.department.TreeDepartmentAllTopComponent")
...
preferredID = "TreeDepartmentAllTopComponent")
public final class TreeDepartmentAllTopComponent extends TopComponent implements ExplorerManager.Provider, ItemListener {
    ...
    public TreeDepartmentAllTopComponent() {
        initComponents();
        setName(NbBundle.getMessage(TreeDepartmentAllTopComponent.class, "CTL_TreeDepartmentTopComponent"));
        setToolTipText(NbBundle.getMessage(TreeDepartmentAllTopComponent.class, "HINT_TreeDepartmentTopComponent"));
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(TreeDepartmentAllTopComponent.class, "TreeDepartmentAllTopComponent.jLabel1.text")); // NOI18N
    ...
    public void componentOpened() {
        ...
        ov.setPropertyColumns(DepartmentNodeAll.Congtyme_PROPERTY, "Công ty",
                DepartmentNodeAll.Giamdoc_PROPERTY, "Trưởng phòng");
        ov.getOutline().setRootVisible(true);
        ov.getOutline().setRowHeight(25);
        panelTree.add(ov, BorderLayout.CENTER);
        Node rootNode = new AbstractNode(new DepartmentParentAll(enterprise));
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (comboBox == cboEnterprise) {
           ...
           // ov1 = new OutlineView("Phòng ban");
            ov1.setPropertyColumns(DepartmentNodeAll.Congtyme_PROPERTY, "Công ty",
                    DepartmentNodeAll.Giamdoc_PROPERTY, "Trưởng phòng");
            ov1.getOutline().setRootVisible(true);
            ov1.getOutline().setRowHeight(25);
            panelTree.add(ov1, BorderLayout.CENTER);
            Node rootNode = new AbstractNode(new DepartmentParentAll(enterprise1));
            explorerManager.setRootContext(rootNode);
