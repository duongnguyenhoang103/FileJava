 ...
 * @author longnt
 */
public class ListProductPanel extends javax.swing.JPanel implements IUserInterface {
    ...
    public ListProductPanel() {
        ...
        tableListPr.setSelectionBackground(new Color(192, 210, 224));
        StripedTableCellRenderer.installInColumn(tableListPr, colorL, null, colorD, null);
    }
    ...
    private void initComponents() {
        ...
        tableListPr.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã",  "Logo", "Tên sản phẩm dịch vụ", "Logo công ty", "Tên công ty", "Phòng phụ thuộc","Phụ trách","Sản phẩm mẹ"
            }
        ));
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện danh sách sản phẩm ";
    }
