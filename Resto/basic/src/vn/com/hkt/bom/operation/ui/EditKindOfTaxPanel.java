...
public class EditKindOfTaxPanel extends javax.swing.JPanel implements IEnterpriseHelp,IUserInterface {

    private KindOfTax KindOfTax;
    private KindOfTaxBN kindOfTaxBN;
    private DefaultTableModel model;
    private List<KindOfTax> list = new ArrayList<KindOfTax>();
    private Collection<? extends IOperationCreater> ieec;

    /** Creates new form EditChucVuPanel */
    public EditKindOfTaxPanel() {
        initComponents();
        kindOfTaxBN = new KindOfTaxBN();
        loadData();
        resetData();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.lbTitle.text")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.jPanel1.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N

        lbDescription.setFont(new java.awt.Font("SansSerif", 0, 12));
        lbDescription.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.lbDescription.text")); // NOI18N

        txtnameClassification.setFont(new java.awt.Font("SansSerif", 0, 12));
        txtnameClassification.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.txtnameClassification.text")); // NOI18N
        ...
        btnCreate.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.btnCreate.text")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.btnEdit.text")); // NOI18N
        ...
        btnDelete.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.btnDelete.text")); // NOI18N
        ...
        btnReset.setText(org.openide.util.NbBundle.getMessage(EditKindOfTaxPanel.class, "EditKindOfTaxPanel.btnReset.text")); // NOI18N
    ...
    private void tabelSelectedRow() {
        ...
        KindOfTax = list.get(tableObject.getSelectedRow());
        txtnameClassification.setText(KindOfTax.getKindOfTaxName());
    ...
    private void removeData() {
        kindOfTaxBN.delete(KindOfTax.getId());
    ...
    private void loadData() {
        ...
        list = kindOfTaxBN.selectAll();
        String[] header = {"Thông số"};
        model = new DefaultTableModel(header, 0);
        for (KindOfTax bean : list) {
            String[] rows = {bean.getKindOfTaxName()};
            model.addRow(rows);
        }
    ...
    private void editData() {
        KindOfTax.setKindOfTaxName(txtnameClassification.getText());
        kindOfTaxBN.update(KindOfTax);
        resetData();
        loadData();
    }

    private void createData() {
        KindOfTax c = new KindOfTax();
        c.setKindOfTaxName(txtnameClassification.getText());
        c.setKindOfTaxId(String.valueOf(Math.random() * 10));
        kindOfTaxBN.insert(c);
        resetData();
        loadData();
    }
    ...
    public String getUserInterfaceDescription() {
        return "Giao diện chỉnh sửa loại thuế";
    }
