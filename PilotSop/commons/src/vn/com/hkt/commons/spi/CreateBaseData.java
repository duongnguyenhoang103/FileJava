...
public class CreateBaseData implements IBaseData {
    ...
    public boolean backUptEnterpriseIntoXML(
        ...
        try {
            ...
            Element eParrent = document.createElement("EnterpriseParrent");
            eParrent.setTextContent(enterpriseParrent);
            Element lg = document.createElement("Logo");
            lg.setTextContent(logo);
            Element slg = document.createElement("Slogan");
            slg.setTextContent(slogan);
    ...
    public void insertEnterpriseIntoDatabasefromXML() {
        ...
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                e.setSlogan(slogan.getTextContent());
                aPI.insertData(e);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
