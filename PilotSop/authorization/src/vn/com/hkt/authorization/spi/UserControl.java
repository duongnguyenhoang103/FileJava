...
public class UserControl implements IAuthorization {
    ...
    public Vector loadUsers() {
        ...
        try {
            pstm = conn.prepareStatement("select a.USERID, a.USERNAME, PASSWORD, DEPARTMENTNAME, a.PERSONID  from ACCOUNT a , DEPARTMENT d where a.DEPARTMENTID=d.DEPARTMENTID");
            ...
            while (rs.next()) {
                ...
                v.addElement(rs.getString("departmentName"));
                data.add(v);
            }
        } catch (Exception ex) {
