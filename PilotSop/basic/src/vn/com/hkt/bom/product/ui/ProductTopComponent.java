...
public final class ProductTopComponent extends TopComponent implements ActionListener, ResetCookieList, Observable, Observer {
    ...
    public void save() {
        ...
        String person ;
        String nhomsp ;
        String ncSX = productPanel.getTableProduct().getValueAt(6, 1).toString().trim();
         String thpho = productPanel.getTableProduct().getValueAt(7, 1).toString().trim();
          String imagePhoTo = productPanel.getTableProduct().getValueAt(8, 1).toString().trim();
        ...
        bean = new Product(id, name, cty, bophan, person, nhomsp,ncSX,thpho,imagePhoTo);
