...
public final class ListProductTopComponent extends TopComponent implements ActionListener, MouseListener {
    ...
    private void txtTimKiemCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtTimKiemCaretUpdate
        ...
        if (cboTimkiem.getSelectedIndex() == 0) {
            String[] header = {"Tên sản phẩm dịch vụ", "Mã sản phẩm dịch vụ", "Công ty", "Bộ phân (Phòng)", "Người chịu trách nhiệm", "Nhóm sản phẩm", "Nước sản xuất", "Thành Phố ", "Ảnh"};
            ...
            for (Product bean : list) {
                ...
                Object[] rows = {bean.getProductName(), bean.getProductID(), enterprise, department, person, product, bean.getIdCity(), bean.getIdCountry(), bean.getImagePhoTo()};
                model.addRow(rows);
            }
                        ...
                        if (bean != null) {
                            ...
                            productTopComponent.getProductPanel().getTableProduct().setModel(new javax.swing.table.DefaultTableModel(
                                    new Object[][]{
                                        ...
                                        {"Nước sản xuất", bean.getIdCity()},
                                        {"Thành Phố", bean.getIdCountry()},
                                        {"Ảnh", bean.getImagePhoTo()}},
                                    new String[]{
                                        "", ""
                                    }) {
