...
public final class PersonTopComponent extends TopComponent implements ActionListener, ResetCookieList, Observer, Observable {
    ...
    public void save() {
        ...
        String image = personPanel.getTabelPerson().getValueAt(6, 1).toString().trim();
        String cty;
        String bophan;

        if (personPanel.getTabelPerson().getValueAt(2, 1) != null) {
            if (personPanel.getTabelPerson().getValueAt(2, 1).toString().trim().length() != 0) {
                Enterprise enterprise = (Enterprise) personPanel.getTabelPerson().getValueAt(2, 1);
                cty = enterprise.getEnterpriseID().trim();
            } else {
                cty = personPanel.getTabelPerson().getValueAt(2, 1).toString().trim();
            }
        } else {
            cty = " ";
        }
        ...
        if (personPanel.getTabelPerson().getValueAt(3, 1) != null) {
            if (personPanel.getTabelPerson().getValueAt(3, 1).toString().trim().length() != 0) {
                Department department = (Department) personPanel.getTabelPerson().getValueAt(3, 1);
                bophan = department.getDepartmentID();
            } else {
                bophan = personPanel.getTabelPerson().getValueAt(3, 1).toString().trim();
            }
        } else {
            bophan = " ";
        }
