...
public class Product {
    ...
    public Product(String ProductID, String ProductName, String EnterpriseID, String DepartmentID, String PersonID, String _productgroups,String _idCity, String _idCountry ,String _imagePhoTo) {
        this.ProductID = ProductID;
        this.ProductName = ProductName;
        this.EnterpriseID = EnterpriseID;
        this.DepartmentID = DepartmentID;
