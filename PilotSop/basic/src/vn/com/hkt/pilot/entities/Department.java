...
public class Department {
    ...
    private String decentralization; // phân cấp
    ...
    public Department(String departmentID, String departmentName, String enterpriseID, String personID, String decentralization, String _departmentParent, String _productID, String _imagePhoTo) {
        this.departmentID = departmentID;
        this.departmentName = departmentName;
        this.enterpriseID = enterpriseID;
        this.personID = personID;
