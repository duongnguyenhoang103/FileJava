...
public final class DepartmentTopComponent extends TopComponent implements ActionListener, ResetCookieList, Observer, Observable {
    ...
    public void save() {
        ...
        String duan_me;
        String spdv;
        String imagePhoTo = departmentPanel.getTableD().getValueAt(7, 1).toString().trim();
        ...
        Department bean = new Department(id, name, enter, person, phancap, duan_me, spdv,imagePhoTo);
